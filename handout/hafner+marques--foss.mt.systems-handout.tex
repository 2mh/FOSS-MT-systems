...
\begin{itemize}
	\item[Shallow-Transfer] Im einfachsten Fall sucht Apertium im Quellsprachtext nach Sequenzmustern von
	...
	\end{enumerate}
	\item[XML] Die linguistischen Daten werden im XML-Format gehalten (vgl. ebd. S.114ff.), aus Gründen
